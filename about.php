...
<head>
    ...
    <!-- Site Metas -->
    <title>Just_One_Clicksdfg ihh</title>
...
<!--  endsearchcode -->
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="images/festive.jfif" style="height:300px" class="img-fluid" alt="Image" />
 
                    </div>
                    
                </div>
                <div class="col-lg-6">
                    <h2 class="noo-sh-title-top">JOC... <span>Just One click</span></h2>
                    <p>"The JOC uses the branded products . All the products are very comfortable to use. Unlimited wardrobe checklist.
                        Summer essentials for your wardrobe. Beauty needs! set your beauty standards .Top women owned brand in India.
                        Empowered by Zara and Adidas. Hoby central- make the most of your she time . Always dreaming about new collections .
                        The wardrobe - her shopping in her way."</p>
                        <p>Top Women owned brands in India. Brands you love on discount.Tom and Jerry collection first on JOC.This star wars day . May the merch be with you!  </p>
